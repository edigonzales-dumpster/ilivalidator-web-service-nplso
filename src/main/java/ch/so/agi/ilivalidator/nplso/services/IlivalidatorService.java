package ch.so.agi.ilivalidator.nplso.services;
...
public class IlivalidatorService {
    ...
    private String ACCEPTED_DATA_MODEL = "SO_Nutzungsplanung_20171118";
    ...
    public synchronized boolean validate(String allObjectsAccessible, String doConfigFile, String inputFileName, String logFileName)
        ...
        if (doConfigFile != null) {
            ...
            if (!modelName.equalsIgnoreCase(ACCEPTED_DATA_MODEL)) {
                throw new IllegalArgumentException("Wrong data model. Only '"+ACCEPTED_DATA_MODEL+"' is accepted.");
            }
